...
<td><img src="images/LOGO3.png" width="250px"height="150px" class="logotheme"></td>
        ...
        <img src='images/handimg.png'width="500px"height="300px"style="float:right";margin:100px 1000px">
        ...
        <table WIDTH="15%" class="tabtheme" cellpadding="2" cellspacing="5"> 
            ...
            <tr align="left">
             ...
             <tr align="left">
                        <td class="tdtheme">product upload</td>
             </tr>
             <tr align="left"> 
                    <td class="tdtheme">view needs</td></tr>
                    </tr> 
               <tr align="left"> 
                   <td class="tdtheme"><a href="settings.jsp">settings</a></td>
               </tr> 
               <tr align="left"> 
                   <td class="tdtheme"><a href="destroysession.jsp" class="link">sign out</a></td>
               </tr> 
        </table>
    </body>       
</html>